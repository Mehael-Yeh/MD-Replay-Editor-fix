...
ENGLISH_TRANSLATIONS = {
    ...
    "最低游戏版本：{version}": "Minimum game version: {version}",
    ...
    "检测到 Master Duel {game}，本程序最低支持 {supported}。请前往 GitHub 获取新版。": "Master Duel {game} was detected, but this app requires {supported} or newer. Visit GitHub for an update.",
    "游戏版本过低或无法识别：游戏 {game}，最低支持 {supported}": "Game version is too old or unrecognized: game {game}, minimum {supported}",
